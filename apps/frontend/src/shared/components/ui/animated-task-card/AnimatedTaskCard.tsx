          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Avatar className="h-6 w-6">
                <AvatarImage src={task.assignee?.avatar && task.assignee.avatar.startsWith('data:image') ? task.assignee.avatar : (task.assignee?.avatar || '/default-avatar.svg')} alt={task.assignee?.name || 'Unassigned'} />
