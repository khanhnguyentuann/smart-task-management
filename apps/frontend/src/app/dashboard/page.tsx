...
import { Loader2, FolderOpen, CheckSquare, Users, TrendingUp, Plus, Activity, Star } from "lucide-react"
...
export default function DashboardPage() {
    ...
    // Enhanced stats data with progress and trends
    const statsData = useMemo(() => [
        {
            ...
            change: projectCount === 0 ? "Create your first project" : "+2 from last month",
            progress: projectCount === 0 ? 0 : 75,
            trend: "up",
                                ...
                                <CardHeader>
                                    <CardTitle className="flex items-center gap-3">
                                        <motion.div
                                            animate={{ scale: [1, 1.1, 1] }}
                                            transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY }}
                                            className="p-2 bg-gradient-to-br from-orange-500 to-red-500 rounded-full shadow-lg"
                                        >
